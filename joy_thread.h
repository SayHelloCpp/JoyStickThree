...
signals:
    ...
    void JoySignal_joystick(joyinfoex_tag);
    void JoySignal_pedal(joyinfoex_tag);


protected:
    void run();
    void send_state_row(joyinfoex_tag state_row);
    void send_state_joystick(joyinfoex_tag state_row);
    void send_state_pedal(joyinfoex_tag state_row);
